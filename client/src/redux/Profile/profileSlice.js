...
export const fetchProfile = createAsyncThunk(
  ...
  async (username, { rejectWithValue }) => {
    try {
      const response = await fetchWithAuth(`http://localhost:3000/${username}`, {
        method: 'GET'
      });
...
export const updateProfile = createAsyncThunk(
  ...
  async (profileData, { rejectWithValue }) => {
    try {
      const response = await fetchWithAuth('http://localhost:3000/api/users/profile-data', {
        method: 'PUT',
...
export const followUser = createAsyncThunk(
  ...
  async (username, { rejectWithValue }) => {
    try {
      const response = await fetchWithAuth(`http://localhost:3000/api/users/${username}/follow`, {
        method: 'PUT'
      });
...
export const unfollowUser = createAsyncThunk(
  ...
  async (username, { rejectWithValue }) => {
    try {
      const response = await fetchWithAuth(`http://localhost:3000/api/users/${username}/unfollow`, {
        method: 'PUT'
      });
